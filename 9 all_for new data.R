...
df1= read.xlsx("I:\\r project up\\demo r prg\\1\\1_maxi_jn_10.xlsx",
...
df1_2 = read.xlsx("I:\\r project up\\demo r prg\\1\\3_maxi_em_10.xlsx",
...
write.xlsx(df1_f,"I:\\r project up\\demo r prg\\1\\r_maximo_needed_1.xlsx",asTable = T,colNames=T)
...
df2= read.xlsx("I:\\r project up\\demo r prg\\1\\5_need_em_10.xlsx",sheet=1,colNames=T,
               detectDates = T)
...
#df2_f= df1_f                     # sheet 2
df2_f= read.xlsx("I:\\r project up\\demo r prg\\1\\5_need_em_10.xlsx",sheet=2,colNames=T,
                 detectDates = F)
